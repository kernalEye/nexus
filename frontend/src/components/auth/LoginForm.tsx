  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-8">
        <h3 className="text-2xl font-bold text-white tracking-tight mb-1.5">Welcome back</h3>
        <p className="text-sm text-slate-400 font-light">Sign in to your observability platform</p>
      </div>
      ...
      <form onSubmit={(e) => e.preventDefault()} className="space-y-5">
        ...
        {/* Utility Filters (Remember Me & Password Recovery) */}
        <div className="flex items-center justify-between text-xs pt-1">
          <label className="flex items-center gap-2 cursor-pointer group text-slate-400 hover:text-slate-300 select-none transition-colors">
            <input 
              type="checkbox" 
              className="w-4 h-4 rounded bg-[#0c0c1d] border-white/[0.1] text-indigo-600 focus:ring-0 focus:ring-offset-0 accent-indigo-500 transition-all duration-200" 
            />
            <span>Remember me</span>
          </label>
          <Link href="/reset-password" className="text-indigo-400 hover:text-indigo-300 font-medium transition-colors">
            Forgot password?
          </Link>
        </div>
        ...
        {/* Visual Content Section Splitter Line */}
        ...
        {/* Alternative OAuth Federated Provisioning Matrix */}
        <div className="grid grid-cols-2 gap-3.5">
          <button type="button" className="flex items-center justify-center gap-2.5 py-2.5 bg-[#0a0a1a] hover:bg-[#101026] border border-white/[0.05] hover:border-white/[0.1] rounded-xl text-xs font-medium text-slate-300 transition-all duration-200">
          ...
          <button type="button" className="flex items-center justify-center gap-2.5 py-2.5 bg-[#0a0a1a] hover:bg-[#101026] border border-white/[0.05] hover:border-white/[0.1] rounded-xl text-xs font-medium text-slate-300 transition-all duration-200">
            <svg className="w-3.5 h-3.5" viewBox="0 0 24 24">
              <path fill="#EA4335" d="M12.24 10.285V14.4h6.887c-.648 2.41-2.519 4.114-5.137 4.114-3.414 0-6.19-2.775-6.19-6.19 0-3.414 2.776-6.19 6.19-6.19 1.483 0 2.844.525 3.918 1.4L21.1 4.5A11.93 11.93 0 0 0 12.24 0c-6.627 0-12 5.373-12 12s5.373 12 12 12c6.912 0 12.24-4.854 12.24-12.24 0-.53-.054-1.018-.147-1.475H12.24Z" />
            </svg>
            Google
          </button>
        </div>
